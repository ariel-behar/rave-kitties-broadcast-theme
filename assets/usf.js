/* USF file - DO NOT MODIFY THIS FILE. THIS FILE IS REGULARLY CHANGED BY USF APP AND **ANY DIRECT CHANGES WILL BE LOST**. Use our in-app customization if you need to update CSS and JS code. Auto modified at: 3/24/2024 12:12:19 PM*/
...
`,
    ...
    <div class="product-item__image usf-sr-product__image-container" :class="{'double__image': hoverImage && _usfGlobalSettings.image_hover_enable}" data-product-image>
        <a class="product-link" :href="productUrl" @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" :aria-label="product.title" :data-product-link="productUrl">
            ...
            <template v-if="product.images.length">
                ...
                <div v-if="hoverImage && _usfGlobalSettings.image_hover_enable" class="product-item__bg__under">
                    <div class="image-wrapper lazy-image is-loading lazy-image--backfill" :style="'--aspect-ratio:' + _usfGetImageRatio(hoverImage) + ';--image-backfill: url(' + hoverImage.url + '&crop=center&height=1&width=1);'" data-aos="img-in" :data-aos-delay="animation_delay" :data-aos-duration="productIndex*100+800" :data-aos-anchor="animation_anchor" data-aos-easing="ease-out-quart">
                        <img :src="hoverImageUrl" :alt="product.title" :srcset="_usfGetSrcset(hoverImage,scaledHoverImageUrl)" :width="hoverImage.width" :height="hoverImage.height" loading="lazy" :sizes="_usf_image_sizes" class="is-loading">
                    </div>
                </div>
            </template>
